...
ALTER TABLE `User` ADD COLUMN `agencyId` VARCHAR(191) NULL,
    ...
    ADD COLUMN `role` ENUM('AgencyOwner', 'AgencyAdmin', 'SubaccountUser', 'SubaccountGuest') NOT NULL DEFAULT 'SubaccountUser',
...
CREATE TABLE `Trigger` (
    `id` VARCHAR(191) NOT NULL,
    `name` VARCHAR(191) NOT NULL,
    `type` ENUM('ContactForm') NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `subAccountId` VARCHAR(191) NOT NULL,
...
CREATE TABLE `Action` (
    `id` VARCHAR(191) NOT NULL,
    `name` VARCHAR(191) NOT NULL,
    `type` ENUM('CreateContact') NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `automationId` VARCHAR(191) NOT NULL,
...
CREATE TABLE `Invitation` (
    ...
    `role` ENUM('AgencyOwner', 'AgencyAdmin', 'SubaccountUser', 'SubaccountGuest') NOT NULL DEFAULT 'SubaccountUser',
